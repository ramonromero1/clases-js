...
while (encendido) {
    ...
    switch(opcion) {
        ...
        case 2:
            ...
            // Creamos un array donde vamos a almacenar solamente el nombre de los productos
            let productosNombres = [];
            // Realizamos un ciclo for of para recorre el array de productos y de esta manera almacenamos los nombres
            // de los productos en el array de productosNombres
            for( let producto of productos) {
                productosNombres.push(producto.nombre);
            }
            // Utilizamos el metodo indexOf para encontrar la posicion del nombre del producto ingresado por el usuario
            ...
            // En caso de que el resultado sea un valor utilizamos el metodo splice para quitar el nombre en la posicion obtenida
            if ( indice !== -1) {
                productos.splice(indice,1);
            }else {
                alert(`No se encontro el producto ${datoUsuario}`);
            }
            break;
